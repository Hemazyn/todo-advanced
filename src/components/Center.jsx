...
function Home() {
     ...
     return (
          <div className={windowSize[0] >= 768 && isSideBarOpen
               ...
               {windowSize[0] >= 768 && (
                    <Sidebar setIsBoardModalOpen={setBoardModalOpen} isBoardModalOpen={BoardModalOpen} isSideBarOpen={isSideBarOpen} setIsSideBarOpen={setIsSideBarOpen} />
               )}
               {/* Columns Section */}
               {columns.length > 0 ? (
                    <>
               ...
               {BoardModalOpen && (<AddEditBoardModal type="edit" setIsBoardModalOpen={setBoardModalOpen} />)}
          </div>
     );
}
